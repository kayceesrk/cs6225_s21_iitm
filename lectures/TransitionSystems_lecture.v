...
(* Proof is not important here, but intuition is. *)
...
(* Relates the [factorial_sys] to the final expected answer *)
...
Proof.
  ...
  invert H.
  invert H0.
  (* 2 subcases for stepping each of the threads *)
  ...
  equality.
  equality.
  (* phew! one thread done. Now onto the other one. *)
