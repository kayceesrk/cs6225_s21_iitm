...
Module ArithWithVariables.
  ...
  Proof.
    ...
    equality.
    equality.
    cases (constantFold e1); cases (constantFold e2);
    cases (constantFold (commuter e2)); 
    cases (constantFold (commuter e1)); try cases n; try cases n1; simplify.
...
Restart.
  ...
  Lemma depth_pushMultiplicationInside' : forall e,
    ...
    (* Pushing multiplication by 0 may increase the depth of the expression 
